...
PluginCore::PluginCore()
{
	...
	kernel.reset(new AuxPort::Effect<float, float>);
...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::PreGain, "PreGain", "Units", controlVariableType::kFloat, 0.000000, 20.000000, 2.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&PreGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: DCOffset
	piParam = new PluginParameter(controlID::DcOffset, "DCOffset", "Units", controlVariableType::kFloat, -1.000000, 1.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&DcOffset, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: PostGain
	piParam = new PluginParameter(controlID::PostGain, "PostGain", "Units", controlVariableType::kFloat, 0.000000, 1.000000, 0.707000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&PostGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- discrete control: DistortionType
	piParam = new PluginParameter(controlID::distortionType, "DistortionType", "None,DCOffset,ZeroCrossing,Clip,arcTan1,arcTan2,Tanh,Tanh2,HWRect1,HWRect2", "None");
	piParam->setBoundVariable(&distortionType, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- continuous control: ReluctanceThreshold
	piParam = new PluginParameter(controlID::Reluctance, "ReluctanceThreshold", "Units", controlVariableType::kFloat, 0.000000, 2.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&Reluctance, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Clip
	piParam = new PluginParameter(controlID::clip, "Clip", "Units", controlVariableType::kFloat, 0.200000, 2.000000, 2.000000, taper::kAntiLogTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&clip, boundVariableType::kFloat);
	addPluginParameter(piParam);
	...
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483651);
	setParamAuxAttribute(controlID::DcOffset, auxAttribute);

	// --- controlID::PostGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483651);
	setParamAuxAttribute(controlID::PostGain, auxAttribute);

	// --- controlID::distortionType
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(805306368);
	setParamAuxAttribute(controlID::distortionType, auxAttribute);

	// --- controlID::Reluctance
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483651);
	setParamAuxAttribute(controlID::Reluctance, auxAttribute);

	// --- controlID::clip
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483651);
	setParamAuxAttribute(controlID::clip, auxAttribute);


	// **--0xEDA5--**
	kernel->push(&PreGain, boundVariableType::kFloat);
	kernel->push(&DcOffset, boundVariableType::kFloat);
	kernel->push(&PostGain, boundVariableType::kFloat);
	kernel->push(&distortionType, boundVariableType::kInt);
	kernel->push(&Reluctance, boundVariableType::kFloat);
	kernel->push(&clip, boundVariableType::kFloat);
...
bool PluginCore::initPluginPresets()
{
	...
	setPresetParameter(preset->presetParameters, controlID::PreGain, 2.000000);
	setPresetParameter(preset->presetParameters, controlID::DcOffset, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::PostGain, 0.707000);
	setPresetParameter(preset->presetParameters, controlID::distortionType, -0.000000);
	setPresetParameter(preset->presetParameters, controlID::Reluctance, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::clip, 2.000000);
	addPreset(preset);
