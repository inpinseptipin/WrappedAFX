...
private:
	...
	enum class distortionTypeEnum { None,DCOffset,ZeroCrossing,Clip,arcTan1,arcTan2,Tanh,Tanh2,HWRect1,HWRect2 };	// to compare: if(compareEnumToInt(distortionTypeEnum::None, distortionType)) etc... 

	// **--0x1A7F--**
    // --- end member variables
	std::unique_ptr<AuxPort::Effect<float, float>> kernel;
